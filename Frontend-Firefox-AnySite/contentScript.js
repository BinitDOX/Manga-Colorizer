...
if (window.injectedMC !== 1) {
    ...
    const canvasContextFromImg = (img) => {
        ...
        imgCanvas.width = img.width; // img.naturalWidth || img.width;
        imgCanvas.height = img.height; // img.naturalHeight || img.height;
    ...
    const colorizeMangaEventHandler = (event=null) => {
        ...
        try {
            browser.storage.local.get(["apiURL", "colTol", "colorStride", "minImgHeight", "minImgHeight"], (result) => {
